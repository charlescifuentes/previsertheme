<?php
/**
 * Credencial Premium Partial template
 *
 * @package understrap
 */
...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="entry-content">
		...
		<div class="row text-center pb-3">
			<div class="col-md-4 pb-3">
				<div class="card benefit">
					<?php $imagen_beneficio_16 = get_field( 'imagen_beneficio_16' ); ?>
					<?php if ( $imagen_beneficio_16 ) { ?>
						<img src="<?php echo $imagen_beneficio_16['url']; ?>" class="card-img-top" alt="<?php echo $imagen_beneficio_16['alt']; ?>" />
					<?php } ?>
					<div class="card-body bg-secondary benefit-body">
						<h5 class="card-title bg-warning benefit-title"><?php the_field( 'titulo_beneficio_16' ); ?></h5>
						<div class="overlay">
							<p class="card-text benefit-text"><?php the_field( 'descripcion_beneficio_16' ); ?></p>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-4 pb-3">
				<div class="card benefit">
					<?php $imagen_beneficio_17 = get_field( 'imagen_beneficio_17' ); ?>
					<?php if ( $imagen_beneficio_17 ) { ?>
					<img src="<?php echo $imagen_beneficio_17['url']; ?>" alt="<?php echo $imagen_beneficio_17['alt']; ?>" />
					<?php } ?>
					<div class="card-body bg-secondary benefit-body">
						<h5 class="card-title bg-warning benefit-title"><?php the_field( 'titulo_beneficio_17' ); ?></h5>
						<div class="overlay">
							<p class="card-text benefit-text"><?php the_field( 'descripcion_beneficio_17' ); ?></p>
						</div>
					</div>
				</div>
			</div>
			<div class="col-md-4 pb-3">
				<div class="card benefit">
					<?php $imagen_beneficio_18 = get_field( 'imagen_beneficio_18' ); ?>
					<?php if ( $imagen_beneficio_18 ) { ?>
						<img src="<?php echo $imagen_beneficio_18['url']; ?>" class="card-img-top" alt="<?php echo $imagen_beneficio_18['alt']; ?>" />
					<?php } ?>
					<div class="card-body bg-secondary benefit-body">
						<h5 class="card-title bg-warning benefit-title"><?php the_field( 'titulo_beneficio_18' ); ?></h5>
						<div class="overlay">
							<p class="card-text benefit-text"><?php the_field( 'descripcion_beneficio_18' ); ?></p>
						</div>
					</div>
				</div>
			</div>
